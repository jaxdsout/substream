...
function Choice ({ load_choice, choice, region}) {
    ...
    return (
        <div className="text-[#ededed] flex flex-col items-center justify-center drop-shadow-md min-w-[349px] max-w-[350px] md:max-w-[600px] md:min-w-[599px] mt-7 mb-10 p-3 bg-[#3b383f] bg-opacity-70 rounded-lg border-t-8 border-b-8 border-[#3b383f] border-opacity-0 transition-all transition-discrete duration-300 ease-in-out">
